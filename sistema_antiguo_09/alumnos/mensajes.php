...
<div id="main">
	...
	<div id="main_inner" class="fluid">
		...
		<!-- inicio -->
				...
				<p>
					<strong>Prof. Ivan:(10/05/2008)</strong> Hola recuerda que nos quedamos de ver a las 10am para ver la tes&iacute;s
					<a href="#">[responder]</a>
				</p>
				<p>
					<strong>Daniel Dice</strong> Que onda a que horas nos vemos para hacer la practica
					<a href="#">[responder]</a>
				</p>
				<p>
					<strong>Pedro dice</strong>Recuerda que tenemos que entregar una presentaci&oacute;n a las 17:00hrs
					<a href="#">[responder]</a>
				</p>
				<hr>
